...
public class Trees_1 {
    private static int cntLeaves(SLLTree<Integer> tree, Tree.Node<Integer> node, Map<Integer, Tree.Node<Integer>> nodes) {
        int cnt = 0;
        ...
        while(children.hasNext()) {
            ...
            cnt += cntLeaves(tree, childNode, nodes);
        }
        return cnt;
    }
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < n + q; i++) {
            ...
            if(parts[0].equals("root")) {
                int rootVal = Integer.parseInt(parts[1]);
                ...
                int leafCount = cntLeaves(tree, node, nodes);
                res.add(leafCount);
            }
        }
